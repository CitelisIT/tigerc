...
public class PredefinedScope implements Scope {
        ...
        public PredefinedScope() {
                ...
                this.addSymbol("print_VAR", new FuncSymbol("void_TYPE",
                                new ArrayList<String>(Arrays.asList("string_TYPE")), "print"));
                this.addSymbol("printi_VAR", new FuncSymbol("void_TYPE",
                                new ArrayList<String>(Arrays.asList("int_TYPE")), "printi"));
                this.addSymbol("flush_VAR",
                                new FuncSymbol("void_TYPE", new ArrayList<String>(), "flush"));
                this.addSymbol("getchar_VAR",
                                new FuncSymbol("string_TYPE", new ArrayList<String>(), "getchar"));
                this.addSymbol("ord_VAR", new FuncSymbol("int_TYPE",
                                new ArrayList<String>(Arrays.asList("string_TYPE")), "ord"));
                this.addSymbol("chr_VAR", new FuncSymbol("string_TYPE",
                                new ArrayList<String>(Arrays.asList("int_TYPE")), "chr"));
                this.addSymbol("size_VAR", new FuncSymbol("int_TYPE",
                                new ArrayList<String>(Arrays.asList("string_TYPE")), "size"));
                this.addSymbol("substring_VAR",
                                new FuncSymbol("string_TYPE",
                                                new ArrayList<String>(Arrays.asList("string_TYPE",
                                                                "int_TYPE", "int_TYPE")),
                                                "substring"));
                this.addSymbol("concat_VAR",
                                new FuncSymbol("string_TYPE", new ArrayList<String>(
                                                Arrays.asList("string_TYPE", "string_TYPE")),
                                                "concat"));
                this.addSymbol("not_VAR", new FuncSymbol("int_TYPE",
                                new ArrayList<String>(Arrays.asList("int_TYPE")), "not"));
                this.addSymbol("exit_VAR", new FuncSymbol("void_TYPE",
